...
On Error GoTo err_SendText
    ...
    PluginSite.Hooks.AddChatText "YMCA> " & strOutput, 13, 0
...
PluginSite.Hooks.AddChatText "YMCA> " & message, Color, 0
...
'    WriteToChat "The External Wav file: " & pFilename & "", 6
  ...
  If check_file_exists = "" Then
    WriteToChat "EXTERANAL SOUND: " & pFilename & " WAS NOT FOUND!", 8
